$(document).ready(function () {
     ...
     */
    var content = [{
        title:  "akuu mauu kakaa bacaa iniii",
        desc: ""
    }, {
        title: "",
        desc: "mungkinn inii cumaa pesann singkatt yang cumaa bisaa akuu sampaiinn ke kakaaa, akuu mintaa maaff yaaa kaloo bikinn kakaa risiii ehehehe"
    }, {
       title: "kakaa tauuu??",
       desc: "mengekspresikannn sebuaaa perasaan adalaa hall yangg amatt teramatt seriuss, karenaa ituu memangg hall yangg tidaa semuaaa oranggg bisaa melakukannyaaa"
    }, {
        title: "",
        desc: "sekaliii lagiii, akuu mintaa maafff yaa kalooo bikinn kakaa tidaa nyamann, terakhirr. terimaa kasii yaa udaa bacaa pesann iniii. dann terakhirr..."
    }, {
        title: "kaa? i have crush on u. kakaa apakaa mengertii? akuu sukaa samaa kakaa sedarii kakaa bilangg 'fian, kirim foto yang pas lomba kemarin dong, nih kirim ke nomer aku aja'",
        desc:  "mungkinn kakaa ndaa nyadarr sii wkwkwk. akuu bakall nungguu balasann darii kakaa kapanpunn kakaa bisaa"
 }];
    var currentPage = 0;
    //generate content
